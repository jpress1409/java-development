...
import com.pluralsight.demo.services.ProductService;
...
@Component
public class NorthwindTradersSpringBoot2ApplicationCLI implements CommandLineRunner {


    private ProductService productService;

    @Autowired
    public NorthwindTradersSpringBoot2ApplicationCLI(ProductService productService) {
        this.productService = productService;
    }

    @Override
    public void run(String... args) {
        ApplicationContext context = SpringApplication.run(NorthwindTradersSpringBoot2ApplicationCLI.class, args);
